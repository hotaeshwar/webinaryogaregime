 ...
 */
function parseFirebaseError(rawError) {
  ...
  if (
    ...
    return "Invalid email or password. If you have not created your admin account in Firebase yet, click the 'Register Admin' tab above to create it.";
  }
...
export async function signInAdmin(email, password) {
  ...
  if (!response.ok) {
    throw new Error(parseFirebaseError(data.error));
  }
